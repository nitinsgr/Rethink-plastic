...
export const AboutContent = () => {
  return(
    <div className=" max-w-7xl mx-auto">
        <h1 className="text-3xl md:text-7xl font-Montserrat font-bold text-blue-900 bg-white transform md:-translate-y-1/2 md:w-2/3 p-5">Let's Rethink Plastic</h1>
        <div className="flex justify-evenly md:mt-10 flex-col md:flex-row">
         <div className="flex flex-col">
           <p className="text-1xl p-5 font-Montserrat md:p-0 text-blue-900">Rethink Plastic is an alliance of leading European NGOs, with thousands of active groups, supporters and citizens in every EU Member State.</p>
           <br/>
          ...
          <div className=" bg-blue-900 md:h-400 p-5">
  ...
  return(
    <div className=" bg-blue-900 mb-20 pb-20">
      <div className="max-w-7xl mx-auto mt-20">
        <h2 className=" bg-white p-5 md:h-24  font-bold text-blue-900 transform  md:-translate-y-1/4 w-screen md:w-3/6  text-4xl md:text-7xl font-Montserrat">Our Campaign</h2>
       <div className="flex flex-col">
  ...
  return(
    <div className="mt-20">
      <div className=" max-w-7xl mx-auto flex flex-col md:flex-row">
        <div>
          <h1 className=" font-Montserrat bg-white transform md:translate-x-20 md:translate-y-10 text-4xl md:text-6x font-bold text-blue-900 p-5 shadow-xl ">The alliance</h1>
        </div>
